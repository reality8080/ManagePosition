...
namespace QuanLiNhanSu_YT
{
    public class Student : Human
    {
        ...
        //Data Source=LAPTOP-49M0TBTC;Initial Catalog=Person;Integrated Security=True
        ...
        //                    //MessageBox.Show($"HumanId: {Id}, Name: {Name}, StudentId: {Birth}, Mssv: {mssv}, Teacher: {teacher}, Subject: {subject}, Score: {score}");
        ...
        //JOIN Student s ON h.Id = s.Id
        //LEFT JOIN Score sc ON s.Mssv = sc.Mssv
        //ORDER BY RIGHT(h.Name, 1) ASC, h.Name ASC"; // Sắp xếp theo chữ cuối cùng và sau đó theo tên
